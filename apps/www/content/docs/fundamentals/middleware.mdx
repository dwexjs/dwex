...
import { corsMiddleware } from "@dwexjs/core";
...
```typescript
import type { MiddlewareFunction } from "@dwexjs/core";
...
```typescript
import { Injectable, type DwexMiddleware } from "@dwexjs/core";
...
```typescript
import { Controller, Get, UseMiddleware } from "@dwexjs/core";
import { LoggerMiddleware } from "./logger.middleware";
...
import type { DwexMiddleware } from "@dwexjs/core";
