...
```typescript
import { Controller, Put, Param, Body } from "@dwex/core";
...
```typescript
import { Controller, Patch, Param, Body } from "@dwex/core";
...
```typescript
import { Controller, Delete, Param } from "@dwex/core";
...
```typescript
import { Controller, Options } from "@dwex/core";
...
```typescript
import { Controller, Head } from "@dwex/core";
...
```typescript
import { Controller, All, Req } from "@dwex/core";
