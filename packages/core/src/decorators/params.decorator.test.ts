...
import { Body, Query, Param, Headers, Cookies, Req, Res, Next, Session, Ip, Host } from "./params.decorator";
...
describe("Parameter Decorators", () => {
	it("should store Body metadata", () => {
		...
		decorator({ constructor: { prototype: { create: mockMethod } } }, "create", 0);
	...
	it("should store Query metadata", () => {
		...
		decorator({ constructor: { prototype: { findAll: mockMethod } } }, "findAll", 0);
	...
	it("should store Param metadata", () => {
		...
		decorator({ constructor: { prototype: { findOne: mockMethod } } }, "findOne", 0);
	...
	it("should store Headers metadata", () => {
		...
		decorator({ constructor: { prototype: { getHeaders: mockMethod } } }, "getHeaders", 0);
	...
	it("should store Req metadata", () => {
		...
		decorator({ constructor: { prototype: { handler: mockMethod } } }, "handler", 0);
