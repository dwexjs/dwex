...
import { DwexFactory, Module, Controller, Get } from "@dwexjs/core";
...
Visit `http://localhost:3000` - you should see "Hello, Dwex!"
...
<Cards>
	...
	<Card title="Learn About Modules" href="/docs/fundamentals/modules" />
</Cards>
